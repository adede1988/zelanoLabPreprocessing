...
%     refinement (1.25x); final bidirectional eligibility snap.
    ...
    bmFeatures.version = ['segmentation: ZLP rev13 (rev12b + 20% trough-to-peak onset floor, 2026-09-01); features: ' ...
    ...
    bmFeatures.conditioning = struct( ...
        ...
        'engineVersion',       'zlp rev13 2026-09-01: rev12b + hard 20% trough-to-peak onset floor (user review of alt6 JH trough detections; see findInhaleOnsets_zlp)', ...
